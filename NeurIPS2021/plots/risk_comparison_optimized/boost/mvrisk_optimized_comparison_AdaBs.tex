...
\pgfplotstableread[col sep=semicolon]{datasets/bin-ada.csv}\tbin
\pgfplotstableread[col sep=semicolon]{datasets/mul-ada.csv}\tmul
...
\nextgroupplot[ymode=log, RiskPlot, RiskPlotBin, title=Binary, xticklabels from table={\tbin}{dataset}, ylabel={$\hat L(\MV_{\rho^*},\testset) / \hat L(\AdaBs,\testset)$}]
%\addplot [Unf]   table[x expr=\coordindex,y=unf_diff,y error minus=unf_q25,y error plus=unf_q75]{\tbin};
\addplot [AdaPr]   table[x expr=\coordindex,y=prior_diff,y error minus=prior_q25,y error plus=prior_q75]{\tbin};
\addlegendentry{$\AdaPr$}
...
%\addplot [AdaPr]   table[x expr=\coordindex,y=prior_diff,y error minus=prior_q25,y error plus=prior_q75]{\tmul};
%\addlegendentry{$\AdaPr$}
