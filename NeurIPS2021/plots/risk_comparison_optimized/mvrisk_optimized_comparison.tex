...
\pgfplotsset{
    RiskPlot/.style={
      ...
      legend style={
        ...
        anchor=south east,at={(0.1,0.83)},legend columns=-1},
      xtick=data,
...
%\addplot [Lam]   table[x expr=\coordindex,y=pbkl_diff,y error minus=pbkl_q25,y error plus=pbkl_q75]{\tbin};
...
\addplot [Bern]   table[x expr=\coordindex,y=bern_diff,y error minus=bern_q25,y error plus=bern_q75]{\tbin};
...
%\addplot [Lam]   table[x expr=\coordindex,y=pbkl_diff,y error minus=pbkl_q25,y error plus=pbkl_q75]{\tmul};
...
\addplot [Bern]   table[x expr=\coordindex,y=bern_diff,y error minus=bern_q25,y error plus=bern_q75]{\tmul};
\addlegendentry{$\rho_{\Bern-g}^*$}
\addplot[line legend, sharp plot, mark=None, black, samples=2,domain=-10:10] {0.0};
\end{groupplot}
\end{tikzpicture}
\end{document}
