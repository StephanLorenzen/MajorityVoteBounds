...
\addplot [Bern]   table[x expr=\coordindex,y=MUBernsteing_diff,y error minus=MUBernsteing_q25,y error plus=MUBernsteing_q75]{\tbin};
...
\addplot [Bern]   table[x expr=\coordindex,y=MUBernsteing_diff,y error minus=MUBernsteing_q25,y error plus=MUBernsteing_q75]{\tmul};
